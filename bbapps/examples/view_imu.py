...
# ///
"""Tiny web visualizer for fused IMU attitude and raw accel/gyro readings."""
...
HTML = """<!DOCTYPE html><html><head><title>IMU Pitch</title>
<style>
...
function draw(){
  ...
  ctx.fillText('pitch (tilt)',w-320,80);
  ...
  raw.innerHTML='<span class="dim">fused roll / pitch (deg)</span>  '+
